...
{
internal:
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ net::allplay::Control::Volume::VolumeVolumeRange^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new net::allplay::Control::Volume::VolumeVolumeRange();
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ net::allplay::Control::Volume::VolumeVolumeRange^ value)
    {
        UNREFERENCED_PARAMETER(signature);
