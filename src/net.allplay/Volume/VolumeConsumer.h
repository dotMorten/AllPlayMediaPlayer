...
public:
    ...
    Windows::Foundation::IAsyncOperation<VolumeAdjustVolumeResult^>^ AdjustVolumeAsync(_In_ int16 interfaceMemberDelta);
    // Call the AdjustVolumePercent method
    Windows::Foundation::IAsyncOperation<VolumeAdjustVolumePercentResult^>^ AdjustVolumePercentAsync(_In_ double interfaceMemberChange);

    // Get the value of the Enabled property.
    Windows::Foundation::IAsyncOperation<VolumeGetEnabledResult^>^ GetEnabledAsync();
    ...
    Windows::Foundation::IAsyncOperation<VolumeSetMuteResult^>^ SetMuteAsync(_In_ bool value);
    ...
    Windows::Foundation::IAsyncOperation<VolumeSetVolumeResult^>^ SetVolumeAsync(_In_ int16 value);
    ...
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<VolumeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ handler) 
        { 
            return _SessionLost += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<VolumeConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>(args));
    ...
    internal: 
        void raise(VolumeConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^ args) 
        { 
    ...
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<VolumeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ handler) 
        { 
            return _SessionMemberAdded += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<VolumeConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(VolumeConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^ args) 
        { 
    ...
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<VolumeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ handler) 
        { 
            return _SessionMemberRemoved += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<VolumeConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(VolumeConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^ args) 
        { 
