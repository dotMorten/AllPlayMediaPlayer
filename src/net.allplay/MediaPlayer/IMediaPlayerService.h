...
public:
	...
	// Implement this function to handle calls to the GetPlaylist method.
	Windows::Foundation::IAsyncOperation<MediaPlayerGetPlaylistResult^>^ GetPlaylistAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info );
    ...
    // Implement this function to handle requests for the value of the PlayState property.
    //
    // Currently, info will always be null, because no information is available about the requestor.
    Windows::Foundation::IAsyncOperation<MediaPlayerGetPlayStateResult^>^ GetPlayStateAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
