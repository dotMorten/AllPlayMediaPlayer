...
public ref class MediaPlayerGetPlaylistCalledEventArgs sealed
{
public:
	MediaPlayerGetPlaylistCalledEventArgs(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
	...
	property MediaPlayerGetPlaylistResult^ Result
	{
		MediaPlayerGetPlaylistResult^ get() { return m_result; }
		void set(_In_ MediaPlayerGetPlaylistResult^ value) { m_result = value; }
	}

	Windows::Foundation::Deferral^ GetDeferral();

	static Windows::Foundation::IAsyncOperation<MediaPlayerGetPlaylistResult^>^ GetResultAsync(MediaPlayerGetPlaylistCalledEventArgs^ args)
	{
		args->InvokeAllFinished();
		auto t = concurrency::create_task(args->m_tce);
		return concurrency::create_async([t]() -> concurrency::task<MediaPlayerGetPlaylistResult^>
		{
			return t;
		});
	}
...
private:
	...
	bool m_raised;
	int m_completionsRequired;
	concurrency::task_completion_event<MediaPlayerGetPlaylistResult^> m_tce;
	std::mutex m_lock;
	Windows::Devices::AllJoyn::AllJoynMessageInfo^ m_messageInfo;
	MediaPlayerGetPlaylistResult^ m_result;
};
...
public ref class MediaPlayerGetPlayStateRequestedEventArgs sealed
{
public:
    MediaPlayerGetPlayStateRequestedEventArgs(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
    ...
    property MediaPlayerGetPlayStateResult^ Result
    {
        MediaPlayerGetPlayStateResult^ get() { return m_result; }
        void set(_In_ MediaPlayerGetPlayStateResult^ value) { m_result = value; }
    }

    Windows::Foundation::Deferral^ GetDeferral();

    static Windows::Foundation::IAsyncOperation<MediaPlayerGetPlayStateResult^>^ GetResultAsync(MediaPlayerGetPlayStateRequestedEventArgs^ args)
    {
        args->InvokeAllFinished();
        auto t = concurrency::create_task(args->m_tce);
        return concurrency::create_async([t]() -> concurrency::task<MediaPlayerGetPlayStateResult^>
        {
            return t;
        });
    }
...
private:
    ...
    bool m_raised;
    int m_completionsRequired;
    concurrency::task_completion_event<MediaPlayerGetPlayStateResult^> m_tce;
    std::mutex m_lock;
    Windows::Devices::AllJoyn::AllJoynMessageInfo^ m_messageInfo;
    MediaPlayerGetPlayStateResult^ m_result;
};
