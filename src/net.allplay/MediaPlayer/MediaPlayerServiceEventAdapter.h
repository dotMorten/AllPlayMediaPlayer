...
public:
	...
	event Windows::Foundation::TypedEventHandler<MediaPlayerServiceEventAdapter^, MediaPlayerGetPlaylistCalledEventArgs^>^ GetPlaylistCalled
	{
		Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<MediaPlayerServiceEventAdapter^, MediaPlayerGetPlaylistCalledEventArgs^>^ handler)
		{
			return _GetPlaylistCalled += ref new Windows::Foundation::EventHandler<Platform::Object^>
				([handler](Platform::Object^ sender, Platform::Object^ args)
			{
				handler->Invoke(safe_cast<MediaPlayerServiceEventAdapter^>(sender), safe_cast<MediaPlayerGetPlaylistCalledEventArgs^>(args));
			}, Platform::CallbackContext::Same);
		}
		void remove(Windows::Foundation::EventRegistrationToken token)
		{
			_GetPlaylistCalled -= token;
		}
	internal:
		void raise(MediaPlayerServiceEventAdapter^ sender, MediaPlayerGetPlaylistCalledEventArgs^ args)
		{
			_GetPlaylistCalled(sender, args);
		}
	}
	...
	event Windows::Foundation::TypedEventHandler<MediaPlayerServiceEventAdapter^, MediaPlayerGetPlayStateRequestedEventArgs^>^ GetPlayStateRequested
	{
		Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<MediaPlayerServiceEventAdapter^, MediaPlayerGetPlayStateRequestedEventArgs^>^ handler)
		{
			return _GetPlayStateRequested += ref new Windows::Foundation::EventHandler<Platform::Object^>
				([handler](Platform::Object^ sender, Platform::Object^ args)
			{
				handler->Invoke(safe_cast<MediaPlayerServiceEventAdapter^>(sender), safe_cast<MediaPlayerGetPlayStateRequestedEventArgs^>(args));
			}, Platform::CallbackContext::Same);
		}
		void remove(Windows::Foundation::EventRegistrationToken token)
		{
			_GetPlayStateRequested -= token;
		}
	internal:
		void raise(MediaPlayerServiceEventAdapter^ sender, MediaPlayerGetPlayStateRequestedEventArgs^ args)
		{
			_GetPlayStateRequested(sender, args);
		}
	}
	...
	virtual Windows::Foundation::IAsyncOperation<MediaPlayerGetPlaylistResult^>^ GetPlaylistAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
    ...
    virtual Windows::Foundation::IAsyncOperation<MediaPlayerGetPlayStateResult^>^ GetPlayStateAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
...
private:
	...
	event Windows::Foundation::EventHandler<Platform::Object^>^ _GetPlaylistCalled;
