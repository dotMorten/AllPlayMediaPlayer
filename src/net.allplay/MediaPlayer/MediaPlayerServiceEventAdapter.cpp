...
IAsyncOperation<MediaPlayerGetPlaylistResult^>^ MediaPlayerServiceEventAdapter::GetPlaylistAsync(_In_ AllJoynMessageInfo^ info)
{
	auto args = ref new MediaPlayerGetPlaylistCalledEventArgs(info);
	GetPlaylistCalled(this, args);
	return MediaPlayerGetPlaylistCalledEventArgs::GetResultAsync(args);
}
...
IAsyncOperation<MediaPlayerGetPlayStateResult^>^ MediaPlayerServiceEventAdapter::GetPlayStateAsync(_In_ AllJoynMessageInfo^ info)
{
	auto args = ref new MediaPlayerGetPlayStateRequestedEventArgs(info);
	GetPlayStateRequested(this, args);
	return MediaPlayerGetPlayStateRequestedEventArgs::GetResultAsync(args);
}
