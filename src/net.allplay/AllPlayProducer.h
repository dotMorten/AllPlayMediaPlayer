...
namespace net { namespace allplay { 

	namespace control { namespace Volume {
			ref class VolumeProducer;
	} }
	namespace MediaPlayer { ref class MediaPlayerProducer; }
	namespace MCU { ref class MCUProducer; }
	namespace ZoneManager { ref class ZoneManagerProducer; }
	ref class AllPlayProducer;// sealed { };

public interface class IAllPlayProducer
{
	event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
	event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
	event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
	event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class AllPlayProducer sealed : [Windows::Foundation::Metadata::Default] IAllPlayProducer
{
public:
	AllPlayProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~AllPlayProducer();

    // The implementation of IVolumeService that will handle method calls and property requests.
    property net::allplay::Control::Volume::VolumeProducer^ Volume
    {
		net::allplay::Control::Volume::VolumeProducer^ get() { return m_volumeProducer; }
    }

	property net::allplay::MediaPlayer::MediaPlayerProducer^ MediaPlayer
	{
		net::allplay::MediaPlayer::MediaPlayerProducer^ get() { return m_mediaPlayerProducer; }
	}

	property net::allplay::MCU::MCUProducer^ MCU
	{
		net::allplay::MCU::MCUProducer^ get() { return m_mcuProducer; }
	}
	
	property net::allplay::ZoneManager::ZoneManagerProducer^ ZoneManager
	{
		net::allplay::ZoneManager::ZoneManagerProducer^ get() { return m_zoneManagerProducer; }
	}

    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ handler)
        { 
            return _Stopped += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllPlayProducer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>(args));
    ...
    internal: 
        void raise(AllPlayProducer^ sender, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^ args)
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ handler)
        { 
            return _SessionLost += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllPlayProducer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(AllPlayProducer^ sender, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^ args)
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ handler)
        { 
            return _SessionMemberAdded += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllPlayProducer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(AllPlayProducer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^ args)
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllPlayProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ handler)
        { 
            return _SessionMemberRemoved += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllPlayProducer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(AllPlayProducer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^ args)
        { 
...
private:
	...
	Control::Volume::VolumeProducer^ m_volumeProducer;
	net::allplay::MediaPlayer::MediaPlayerProducer^ m_mediaPlayerProducer;
	net::allplay::MCU::MCUProducer^ m_mcuProducer;
	net::allplay::ZoneManager::ZoneManagerProducer^ m_zoneManagerProducer;
